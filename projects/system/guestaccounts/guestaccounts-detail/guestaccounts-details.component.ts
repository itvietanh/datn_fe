...
@Component({
  ...
  templateUrl: './guestaccounts-details.component.html',
  styleUrls: ['./guestaccounts-details.component.scss'],
})
export class GuestAccountsDetailComponent implements OnInit {
  @Input() id: any;
  @Input() uuid: any;
  @Input() mode: any;
