...
@Component({
  selector: 'app-guest-statistical-detail',
  templateUrl: './guest-statistical-detail.component.html',
  styleUrls: ['./guest-statistical-detail.component.scss']
})
export class  GuestStatisticalDetailComponent implements OnInit {
